...
You manage a personal knowledge base of problems and solutions at `~/.claude/knowledge-base/`.

## Directory Structure

```
~/.claude/knowledge-base/
  KBINDEX.md                    # Index file — one-line summaries with tags
  entries/
    python/                     # Category folders
      uv-codeartifact-auth.md
    cli/
      git-hook-gpg-failure.md
    infra/
      mirrord-timeout.md
```
...
- **save** — message contains "save", "remember this", "file this", "love letter", or describes a problem that was just solved
- **search** — message contains "search", "find", "have we seen", "recall", "check if", or describes a problem they're encountering
- **list** — message contains "list", "browse", "show all", "what do we have"

If unclear, ask: "Want me to save something or search for something?"
